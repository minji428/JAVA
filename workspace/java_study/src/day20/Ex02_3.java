	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			// 1등 학생 성적 확인
				...
				System.out.println("학번 : "+mega.arHakbun[maxNum]);
			...
			// 꼴등 학생 성적 확인
				...
				System.out.println("학번 : "+mega.arHakbun[minNum]);
			...
			// 성적 확인 하기
				...
				if(check == -1) {
					...
					System.out.println(hakbun + "학번 학생의 성적은 "+mega.arScore[check]);
				}
			}
			// 종료하기
			else if(choice == 5) {
